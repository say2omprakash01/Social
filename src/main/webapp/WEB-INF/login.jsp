...
.login-wrap {
    ...
    min-height: 640px;
    position: relative;
    background: linear-gradient(to bottom, #b3d1ff, #0057b7); /* Smooth gradient from very light blue to blue */
...
.foot-lnk {
 ...
 function validateRegister() {
	    ...
	    var email = document.getElementById("eemail").value; // Using eemail as per requirement
	    var password = document.getElementById("ppassword").value; // Using ppassword as per requirement
	    ...
	    if (email.trim() === "") {
	        ...
	        required[2].innerHTML = "Invalid Email Format.";
	        result = false;
	    }
	    if (password.trim() === "") {
	    ...
	    if (password !== confirmPassword) {
	        required[3].innerHTML = "Passwords do not match.";
	        required[4].innerHTML = "Passwords do not match.";
	        result = false;
	    }
        ...
        <div class="login-html">
            ...
            <div class="login-form">
                ...
                <div class="sign-up-htm">
                    <form method="post" action="${pageContext.request.contextPath}/register" onsubmit="return validateRegister()">
                        <div class="group">
                        ...
                        <div class="group">
                            ...
                            <input id="eemail" name="email" type="text" class="input">
                            <div class="required"></div>
                        </div>
                        <div class="group">
                            <label for="password" class="label">Password
                            </label>
                            <input id="ppassword" name="password" type="password" class="input" data-type="password">
                            <div class="required"></div>
                        </div>
                        <div class="group">
                            <label for="cpassword" class="label">Confirm Password
                            </label>
